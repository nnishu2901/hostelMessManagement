...
<div id="reg">
 <div id="inner">
  ...
  <form action="delete.php" method="post" autocomplete="off">
    <br/><label>Worker ID</label><input type="text" id="wid" name="wid" maxlength="11" size="30"/><br /><br /><br />
   </div>
  <div id="center">
   <input type="submit" id="submit"  value="Delete" name="present" style="background:-webkit-linear-gradient(grey,black);"/><br /><br />
  </form>
  </div>
</div>
</body>
