...
<title>Update mess advance fees!!</title>
...
<div id="reg">
 <div id="inner">
  <p >Mess advance fees for next sem !!</p> 
 </div>
  <div id="outer">
  <form action="after_update_fees.php" method="post" autocomplete="off">
    <br /><label>Fees : </label><input type="text" id="fees" name="fees" maxlength="11" size="30"/>
   </div> <br/>
  <div id="center">
   <br /><input type="submit" id="submit"  value="Update fees" style="background:-webkit-linear-gradient(grey,black);"/><br />
