<?php
	...
	if(!isset($_SESSION['msg']))
		header('Location: profile.php',303);
	else {
?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div id="dlgbox">
		...
		<div id="dlg-footer">
			<a href="" id="set"><input type="button" style="display:none;" id="button" value="" ></a>
			<?php 
			...
			?>
					<a href="profile.php"><input type="button" value="OK" ></a>
			<?php
			}
			?>			
		</div>
...
<script>
	...
	function showHref(error,href,value) {
		var whitebg=document.getElementById('whitebg');
		var dlg=document.getElementById('dlgbox');
		var a=document.getElementById('set');
		var val=document.getElementById('button');
		a.href=href;
		val.value=value;
		document.getElementById('dlg-body').innerHTML=error;
		var winWidth=window.innerWidth;
...
<?php
		if(isset($_SESSION['link'])) {
			echo "<script>showHref('".$_SESSION['msg']."','".$_SESSION['link']."','".$_SESSION['value']."');</script>";
			unset($_SESSION['link']);
