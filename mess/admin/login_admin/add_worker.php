...
<div id="reg">
	...
	<div id="not" style="position:relative;left:6%;color:red;font-weight:bold;margin-bottom:8px;"></div>
		<form action="register.php" method="post" autocomplete="off">
			<label>Name </label><input type="text" id="wname" name="wname" maxlength="20" size="30" autofocus/><hr />
			<label>Phone Number </label><input type="text" id="phno" name="phno" maxlength="10" size="30"/><hr />
			<label>Address </label><input type="text" id="address" name="address"  maxlength="20"  size="30" /><hr />
			<label>Type </label>
			<select  id="wtype"  style="font-size:20px; font-family:monotype corsiva; width:200px; margin-left:70px;"   name="type_select">
