<?php
	...
	if(isset($_POST['sid'])){
		$sid=$_POST['sid'];
		if(empty($sid)) {
			$_SESSION['msg']='Please fill student id';
...
<div id="reg">
 ...
 <div id="outer">
  <form action="enter_amount.php" method="post" autocomplete="off">
    <label>Password </label><input type="password" id="pwd" name="pwd" class="hover" maxlength="20" size="30" /><br /><br /><br />
   </div> 
   <input type="hidden" id="student" value="<?php echo $_SESSION['student'];?>" name="student">
  <div id="center">
