...
define("SMTP_UNAME", "2013UCP1089@mnit.ac.in"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "veer@1008"); //Password for SMTP authentication
