...
<div id="reg">
 <div id="inner">
  ...
  <form action="smtpgmail.php" method="post" autocomplete="off">
    <label>User Id</label><input type="text" id="uid" name="uid" maxlength="11" size="30"/><br /><br /><br />
   </div> 
  <div id="center">
   <input type="submit" id="submit"  value="submit" style="background:-webkit-linear-gradient(grey,black);"/><br /><br />
  </form>
  </div>
</div>
</body>
